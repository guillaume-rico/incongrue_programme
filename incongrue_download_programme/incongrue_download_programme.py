    ...
    for line in r.text.split("\n") :
        if "tribe-event-date-start" in line :
            ...
            if "tribe-event-time" in line :
                ...
                #print(cleanLineSplit)
                
                jourEvenement = datetime.datetime.strptime(cleanLineSplit[0] + " " + cleanLineSplit[1] + " " + str(anneeActuelle),'%d %m %Y')
                ...
                heureDepSplit = cleanLineSplit[3].split(":")
                heureFinSplit = cleanLineSplit[5].split(":")
                ...
                cleanLineSplit = cleanLine.split(" ")
                #print("multijour - " + str(cleanLineSplit))
                jourEvenement = datetime.datetime.strptime(cleanLineSplit[0] + " " + cleanLineSplit[1] + " " + str(anneeActuelle),'%d %m %Y')
                event["dateHard"] = jourEvenement
                event["date"] = "Du " + cleanLineSplit[0] + " au " + cleanLineSplit[3] 
                
            # On a deja eu le titre, on a maintenant la date, on peut écrire
            if args.option_download == "monthevt" :
        ...
        if nl >= 1 :
            ...
            if nl == 4 :
                ...
                print("nl : " + str(nl) + " - " + html.unescape(line.replace('</a>',"").replace("\xa0"," ").strip()))
